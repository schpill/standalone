...
.ms-container .ms-selection li.disabled {
  ...
  cursor: text;
        ...
        {
            if(!is_dir(APPLICATION_PATH . DS . 'models' . DS . 'CrudWay')) {
                File::mkdir(APPLICATION_PATH . DS . 'models' . DS . 'CrudWay');
            }

            $file = APPLICATION_PATH . DS . 'models' . DS . 'CrudWay' . DS . ucfirst(Inflector::camelize($database)) . DS . ucfirst(Inflector::camelize($model)) . '.php';

            if (!is_dir(APPLICATION_PATH . DS . 'models' . DS . 'CrudWay' . DS . ucfirst(Inflector::camelize($database)))) {
                File::mkdir(APPLICATION_PATH . DS . 'models' . DS . 'CrudWay' . DS . ucfirst(Inflector::camelize($database)));
            }
