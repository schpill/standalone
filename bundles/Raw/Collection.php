<?php
	...
	class Collection implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
	{
		...
		*/
		...
		{
			return array_first($this->items, function($item) use ($id) {
				return is_object($item) ? $item->id == $id : $item['id'] == $id;
			}, $default);
		}
		...
		public function fetch($key)
		{
			return new self(array_fetch($this->toArray(), $key));
		}

		public function native()
		{
			return lib('collection', [$this->items]);
		}
	}
