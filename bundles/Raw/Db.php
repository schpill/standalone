<?php
    ...
    class Db
    {
        ...
        public function __construct($db, $table)
        {
            ...
            Now::set('raw.store.' . $this->collection, $store);

            $this->getAge();

            lib('facade', ['SplFixedArray', 'RawArray']);
        }
        ...
        public static function instance($db, $table)
        {
            ...
            $has    = Instance::has('Raw', $key);

            if (true === $has) {
                return Instance::get('Raw', $key);
            } else {
                return Instance::make('Raw', $key, new self($db, $table));
            }
        }
        ...
        public function model($data = [])
        {
            ...
            $dir = Conf::get('dir.raw.models', APPLICATION_PATH . DS . 'models' . DS . 'Raw');
        ...
        {
            if ($k == 'store') {
                return Now::get('raw.store.' . $this->collection);
            } else {
