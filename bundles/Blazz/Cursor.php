<?php
    ...
    class Cursor implements Countable, Iterator
    {
        ...
        public function multisort($ids, $sorts)
        {
            ...
            return BlazzArray::fromArray($idsSorted);
        }
        ...
        public function toArray()
        {
            ...
            if (empty($this->selects)) {
                return BlazzArray::fromArray(array_map(function ($row) {
                    $row = $this->getRow($row);
                ...
                return BlazzArray::fromArray(array_map(function ($id) use ($fields) {
                    $row = [];
                    $row['id'] = $id;
        ...
        public function cursor()
        {
            if (!isset($this->cursor)) {
                ...
                if (!$ids) {
                    ...
                    $ids = BlazzArray::fromArray($ids);
                } else {
                    if (is_object($ids)) {
                        $ids = BlazzArray::fromArray(iterator_to_array($ids));
                    } else {
                        $ids = BlazzArray::fromArray($ids);
                    }
                }
                ...
                if (isset($this->limit)) {
                    ...
                    $this->cursor = BlazzArray::fromArray(
                        array_slice(
                            $this->cursor,
                            $offset,
                            $this->limit
