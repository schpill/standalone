...
.ms-container .ms-selection li.disabled {
  ...
  cursor: text;
        ...
        {
            if(!is_dir(APPLICATION_PATH . DS . 'models' . DS . 'CrudNosql')) {
                File::mkdir(APPLICATION_PATH . DS . 'models' . DS . 'CrudNosql');
            }

            $file = APPLICATION_PATH . DS . 'models' . DS . 'CrudNosql' . DS . ucfirst(Inflector::camelize($database)) . DS . ucfirst(Inflector::camelize($model)) . '.php';

            if (!is_dir(APPLICATION_PATH . DS . 'models' . DS . 'CrudNosql' . DS . ucfirst(Inflector::camelize($database)))) {
                File::mkdir(APPLICATION_PATH . DS . 'models' . DS . 'CrudNosql' . DS . ucfirst(Inflector::camelize($database)));
            }
