<?php
    ...
    class Db
    {
        ...
        public function __construct($db, $table)
        {
            ...
            lib('facade', ['SplFixedArray', 'NosqlArray']);
        }
        ...
        public static function instance($db, $table)
        {
            ...
            $has    = Instance::has('Nosql', $key);

            if (true === $has) {
                return Instance::get('Nosql', $key);
            } else {
                return Instance::make('Nosql', $key, new self($db, $table));
            }
        }
        ...
        public function model($data = [])
        {
            ...
            $dir = Conf::get('dir.nosql.models', APPLICATION_PATH . DS . 'models' . DS . 'Nosql');
            ...
            if (!File::exists($modelFile)) {
                File::put($modelFile, str_replace('##class##', ucfirst(Inflector::lower($db)) . ucfirst(Inflector::lower($table)) . 'NosqlModel', File::read(__DIR__ . DS . 'dbModel.tpl')));
            }

            $class = '\\Thin\\' . ucfirst(Inflector::lower($db)) . ucfirst(Inflector::lower($table)) . 'NosqlModel';
