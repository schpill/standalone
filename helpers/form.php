<?php
    ...
    class FormLib
    {
        protected $html, $csrfToken, $model, $labels = [];
        use Macroable;
        ...
        {
            $method = isAke($options, 'method', 'post');
        ...
        {
            return $this->hidden('token', $this->csrfToken);
        }
        ...
        protected function setTextAreaSize($options)
        {
            ...
            $cols = isAke($options, 'cols', 50);

            $rows = isAke($options, 'rows', 10);
         ...
         * @return string
         */
        public function image($src, $name = null, $attributes = array())
        {
            $attributes['src'] = $src;
        ...
        protected function getModelValueAttribute($name)
        {
            if (is_object($this->model)) {
                return object_get($this->model, $this->transformKey($name), null);
            } elseif (is_array($this->model)) {
                return isAke($this->model, $this->transformKey($name), null);
            }
        }
        ...
        public function old($name)
        {
            if (isset($this->session)) {
                return session(SITE_NAME)->getOldInput($this->transformKey($name));
            }
        }
        ...
        {
            return isset($this->session) && count(session(SITE_NAME)->getOldInput()) == 0;
        }
         ...
         * @return $this
         */
        public function setSessionStore(SessionLib $session)
        {
