<?php
	...
	use Illuminate\Contracts\Container\ContextualBindingBuilder as CBB;
	use Illuminate\Contracts\Container\Container as CC;

	class AppLib implements AA, CC
	{
		/**
		...
		{
			if (!is_array($abstract) && !is_object($abstract)) {
		...
		/**
		 * Make the shared instance of the container.
		 *
		 * @return void
		 */
