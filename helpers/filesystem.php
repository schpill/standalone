<?php
    ...
    class FilesystemLib extends FilesystemBase
    {
        /**
        ...
        {
            return strpos($path, bAPPLICATION_PATH) === 0;
        }
        ...
        {
            if (self::exists($path)) return $path;
        ...
        {
            if ($mask = $this->getFolderPermissions()) $mode = $mask;
