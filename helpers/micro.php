<?php
    ...
    class MicroLib extends Container implements ApplicationContract, HttpKernelInterface
    {
        /**
        ...
        /**
         * Create a new MicroLib application instance.
         *
        ...
        {
            return 'MicroLib (1.0.1) (Thin Components 1.9.*)';
        }
        ...
        protected function registerLogBindings()
        {
            $this->singleton('Psr\Log\LoggerInterface', function () {
                return new Logger('MicroLib', [$this->getMonologHandler()]);
            });
        }
        ...
        protected function getMonologHandler()
        {
            return (
                new StreamHandler(
                    storage_path('logs/MicroLib.log'),
                    Logger::DEBUG
                )
            )->setFormatter(
        ...
        protected function getLanguagePath()
        {
            if (is_dir($appPath = $this->resourcePath('lang'))) {
                ...
                return APPLICATION_PATH . DS . '/translations';
            }
        }
        ...
        {
            $appConfigPath = ($this->configPath ?: $this->basePath('config')) . DS . $name . '.php';

            if (file_exists($appConfigPath)) {
                return $appConfigPath;
            } elseif (file_exists($path = APPLICATION_PATH . DS .'configs/' . $name . '.php')) {
                return $path;
            }
        }
        ...
        protected function callControllerAction($routeInfo)
        {
            ...
            if ($instance instanceof Routing\Controller) {
                return $this->callMicroController($instance, $method, $routeInfo);
            } else {
        ...
        /**
         * Send the request through a MicroLib controller.
         *
         ...
         * @return mixed
         */
        protected function callMicroController($instance, $method, $routeInfo)
        {
            ...
            if (count($middleware) > 0) {
                return $this->callMicroControllerWithMiddleware(
         ...
         * @return mixed
         */
        protected function callMicroControllerWithMiddleware($instance, $method, $routeInfo, $middleware)
        {
        ...
        /**
         * Get the HTML from the MicroLib welcome screen.
         *
         * @return string
         */
