<?php
    ...
    class DiffLib
    {
        ...
        public static function compare($string1, $string2, $compareCharacters = true)
        {
            // $string1 = utf8_decode(utf8_decode($string1));
            // $string2 = utf8_decode(utf8_decode($string2));
       ...
       */
        public static function compareFiles($file1, $file2, $compareCharacters = true)
        {
