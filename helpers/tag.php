    ...
    class TagLib
    {
        ...
        */
        ...
        public static function isVoid($tag)
        {
            ...
            return in_array(Inflector::lower($tag), $void);
        }
        ...
        public static function tag($name, $content = null, $attr = [])
        {
            if (is_array($content)) {
                $attr    = $content;
                $content = null;
        ...
        public static function a($href, $text = null, $attr = [])
        {
        ...
        public static function email($email, $text = null, $attr = [])
        {
        ...
        {
            return '<!--[if lt IE 9]>' . PHP_EOL . '<script src="//html5shiv.googlecode.com/svn/trunk/html5.js"></script>' . PHP_EOL . '<![endif]-->' . PHP_EOL;
        }
    }
