<?php
     ...
     *
     */
    class TimeLib extends DateTime
    {
        /**
         * The day constants
         */
        ...
        /**
         * A test TimeLib instance to be returned when now instances are created
         *
         * @var TimeLib
         */
        ...
        /**
         * Create a TimeLib instance from a DateTime one
         *
         * @param DateTime $dt
         *
         * @return static
        ...
        /**
         * Create a TimeLib instance from a string.  This is an alias for the
         * constructor that allows better fluent syntax as it allows you to do
         * TimeLib::parse('Monday next week')->fn() rather than
         * (new TimeLib('Monday next week'))->fn()
         *
         * @param string              $time
         * @param DateTimeZone|string $tz
         *
        ...
        /**
         * Get a TimeLib instance for the current date and time
         *
         * @param DateTimeZone|string $tz
         *
         * @return static
        ...
        /**
         * Create a TimeLib instance for today
         *
         * @param DateTimeZone|string $tz
         *
         * @return static
        ...
        /**
         * Create a TimeLib instance for tomorrow
         *
         * @param DateTimeZone|string $tz
         *
         * @return static
        ...
        /**
         * Create a TimeLib instance for yesterday
         *
         * @param DateTimeZone|string $tz
         *
         * @return static
        ...
        /**
         * Create a TimeLib instance for the greatest supported date.
         *
         * @return TimeLib
         */
        ...
        /**
         * Create a TimeLib instance for the lowest supported date.
         *
         * @return TimeLib
         */
        ...
        /**
         * Create a new TimeLib instance from a specific date and time.
         *
        ...
        /**
         * Create a TimeLib instance from just a date. The time portion is set to now.
         *
         * @param integer             $year
         * @param integer             $month
         * @param integer             $day
        ...
        /**
         * Create a TimeLib instance from just a time. The date portion is set to today.
         *
         * @param integer             $hour
         * @param integer             $minute
         * @param integer             $second
        ...
        /**
         * Create a TimeLib instance from a specific format
         *
         * @param string              $format
         * @param string              $time
         * @param DateTimeZone|string $tz
        ...
        /**
         * Create a TimeLib instance from a timestamp
         *
        ...
        /**
         * Create a TimeLib instance from an UTC timestamp
         *
         * @param integer $timestamp
         *
         * @return static
        ...
        /**
         * Get a part of the TimeLib object
         *
         * @param string $name
         *
         * @throws InvalidArgumentException
        ...
        /**
         * Set a part of the TimeLib object
         *
         * @param string                      $name
        ...
        /**
         * Set a TimeLib instance (real or mock) to be returned when a "now"
         * instance is created.  The provided instance will be returned
         * specifically under the following conditions:
         *   - A call to the static now() method, ex. TimeLib::now()
         *   - When a null (or blank string) is passed to the constructor or parse(), ex. new TimeLib(null)
         *   - When the string "now" is passed to the constructor or parse(), ex. new TimeLib('now')
         *
         ...
         * parameter of null.
         *
         * @param TimeLib $testNow
         */
        public static function setTestNow(TimeLib $testNow = null)
        {
            self::$testNow = $testNow;
        }

        /**
         * Get the TimeLib instance (real or mock) to be returned when a "now"
         * instance is created.
         *
        ...
        /**
         * Reset the format used to the default when type juggling a TimeLib instance to a string
         *
         */
        ...
        /**
         * Set the default format used when type juggling a TimeLib instance to a string
         *
         * @param string $format
         */
         ...
         * @return boolean
         */
        public function gte(TimeLib $dt)
        {
            return $this >= $dt;
        }
         ...
         * @return boolean
         */
        public function lte(TimeLib $dt)
        {
            return $this <= $dt;
        }
       ...
       * @return boolean
       */
        public function between(TimeLib $dt1, TimeLib $dt2, $equal = true)
        {
            if ($dt1->gt($dt2)) {
                $temp = $dt1;
                $dt1 = $dt2;
         ...
         * @return static
         */
        public function min(TimeLib $dt = null)
        {
         ...
         * @return static
         */
        public function max(TimeLib $dt = null)
        {
            $dt = ($dt === null) ? self::now($this->tz) : $dt;
         ...
         * @return boolean
         */
        public function isSameDay(TimeLib $dt)
        {
         ...
         * @return integer
         */
        public function diffInYears(TimeLib $dt = null, $abs = true)
        {
            $dt = ($dt === null) ? self::now($this->tz) : $dt;
         ...
         * @return integer
         */
        public function diffInMonths(TimeLib $dt = null, $abs = true)
        {
            $dt = ($dt === null) ? self::now($this->tz) : $dt;
         ...
         * @return integer
         */
        public function diffInWeeks(TimeLib $dt = null, $abs = true)
        {
         ...
         * @return integer
         */
        public function diffInDays(TimeLib $dt = null, $abs = true)
        {
            $dt = ($dt === null) ? self::now($this->tz) : $dt;
          ...
          * @return int
          */
         public function diffInDaysFiltered(Closure $callback, TimeLib $dt = null, $abs = true)
         {
              $start = $this;
              ...
              $days = array_filter(iterator_to_array($period), function (DateTime $date) use ($callback) {
                    return call_user_func($callback, TimeLib::instance($date));
              });
          ...
          * @return int
          */
         public function diffInWeekdays(TimeLib $dt = null, $abs = true)
         {
              return $this->diffInDaysFiltered(function (TimeLib $date) {
          ...
          * @return int
          */
         public function diffInWeekendDays(TimeLib $dt = null, $abs = true)
         {
              return $this->diffInDaysFiltered(function (TimeLib $date) {
         ...
         * @return integer
         */
        public function diffInHours(TimeLib $dt = null, $abs = true)
        {
         ...
         * @return integer
         */
        public function diffInMinutes(TimeLib $dt = null, $abs = true)
        {
         ...
         * @return integer
         */
        public function diffInSeconds(TimeLib $dt = null, $abs = true)
        {
         ...
         * @return string
         */
        public function diffForHumans(TimeLib $other = null, $absolute = false)
        {
            $isNow = $other === null;
         ...
         * Use the supplied consts to indicate the desired dayOfWeek, ex. self::MONDAY.
         *
         * @param int $nth
         * @param int $dayOfWeek
         *
         ...
         * @return static
         */
        public function average(TimeLib $dt = null)
        {
            $dt = ($dt === null) ? self::now($this->tz) : $dt;
         ...
         * @return boolean
         */
        public function isBirthday(TimeLib $dt)
        {
