<?php
    ...
    class TplLib
    {
         ...
         * @return string
         */
        public function script($attributes = array(), $secure = null)
        {
         ...
         * @return string
         */
        public function style($attributes = array(), $secure = null)
        {
         ...
         * @return string
         */
        public function image($src, $alt = null, $attributes = array(), $secure = null)
        {
            $attributes['alt'] = $alt;
         ...
         * @return string
         */
        public function link($href, $title = null, $attributes = array())
        {
            if (is_null($title) || $title === false) $title = $href;

            return '<a href="' . $href . '"' . $this->attributes($attributes) . '>' . $this->entities($title) . '</a>';
        }
