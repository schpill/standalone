<?php
    ...
    class CurlLib
    {
         ...
         * @access public
        */
        function sendPostData($url, $postdata, $arrayHeader = null, $ip = null, $timeout = 600)
        {
            //set various curl options first
            if($this->debug)  curl_setopt($this->ch, CURLOPT_VERBOSE, true);
            ...
            // set header
            if ($arrayHeader != null) curl_setopt($this->ch, CURLOPT_HTTPHEADER, $arrayHeader);
        ...
        */
        ...
        function sendPostContent($url, $headersdata, $postdata, $content, $ip = null, $timeout = 10)
        {
            if($this->debug)
                curl_setopt($this->ch, CURLOPT_VERBOSE, true);
            //set various curl options first
            ...
            curl_setopt(
                ...
                CURLOPT_HTTPHEADER,
                array_merge(
                    array('Content-Length: ' . strlen($post_string)),
                    $headersdata
                )
            );
        ...
        function sendPutData($url, $headersdata,$putdata, $ip = null, $timeout = 10)
        {
            if ($this->debug) curl_setopt($this->ch, CURLOPT_VERBOSE, true);
            //set various curl options first
        ...
        function sendDelete($url, $ip = null, $timeout = 10)
        {
            if ($this->debug) curl_setopt($this->ch, CURLOPT_VERBOSE, true);
            //set various curl options first
