<?php
    ...
    class EnvLib
    {
        ...
        public static function load($path, $file = '.env')
        {
            ...
            if (!is_readable($filePath) || !is_file($filePath)) {
                throw new \InvalidArgumentException(
                    sprintf(
                        'EnvLib: Environment file %s not found or not readable. '.
        ...
        public static function setEnvironmentVariable($name, $value = null)
        {
            ...
            if (true === static::$immutable && !is_null(static::findEnvironmentVariable($name))) {
                return;
            }
            ...
            if (strpos($value, '$') !== false) {
                $value = preg_replace_callback(
                    ...
                    function ($matchedPatterns) {
                        $nestedVariable = lib('env')->findEnvironmentVariable($matchedPatterns[1]);
